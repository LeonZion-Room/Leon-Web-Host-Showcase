...
- Production：**https://leon-blog-7f9.pages.dev/**（Cloudflare Pages，2026-09-19 上线）
...
# 3. 部署到 Cloudflare Pages（leon-blog）
export CLOUDFLARE_API_KEY='<全局API Key>' CLOUDFLARE_EMAIL='leonzion7@outlook.com' CLOUDFLARE_ACCOUNT_ID='52eb8412db1bac1c0de81e7a3551e7b2'
npx --yes wrangler@3.107.3 pages deploy /tmp/showcase-deploy --project-name=leon-blog --branch=main
```
...
- Cloudflare 凭证登记：开发相关 > 开发-速查 > Cloudflare-账户与GlobalKey-20260919